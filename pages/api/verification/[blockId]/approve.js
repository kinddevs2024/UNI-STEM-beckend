...
/**
 * @swagger
 * /api/verification/{blockId}/approve:
 *   patch:
 *     summary: Approve block verification (Admin only)
 *     tags: [Verification]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Block approved successfully
 *       401:
  ...
  try {
    ...
    const verificationUpdate = {
      verification: {
        ...
        note: note || blockWithVerification.verification?.note || null,
